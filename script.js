...
var I18N = {
  ...
  ru: {
    ...
    'price.note': 'Цена от 170 000 ₸ на человека. Итоговая стоимость зависит от программы тура, даты запуска и количества участников.',
    'price.unit': '/ человека',
    ...
    't2.note': 'Пилотируемый пуск - 470 000 ₸ · беспилотный - от 320 000 ₸',
    ...
    'why.w5t': '100% возврат',
    'why.w5x': 'При отмене запуска гарантируется 100% возврат. В случае изменения или переноса запуска мы предложим альтернативную дату, изменение программы или возврат средств в соответствии с условиями договора.',
    ...
    'nav.reviews': 'Отзывы',
    'rev.title': 'Отзывы туристов',
    'rev.sub': 'Реальные впечатления гостей Байконура',
    'rev.avg': '4.9 из 5 - по отзывам туристов',
    'rev.r1name': 'Ли Вэй',
    'rev.r1loc': 'Китай',
    'rev.r1text': 'С детства мечтал увидеть запуск ракеты. TravelHub всё взял на себя: пропуска, гид на китайском, трансферы. Наблюдали старт с официальной площадки - эмоции невероятные!',
    'rev.r2name': 'Thomas M.',
    'rev.r2loc': 'Германия',
    'rev.r2text': 'Очень профессиональная команда. Все разрешения и документы оформили за нас - нам осталось только приехать и наслаждаться. Однозначно рекомендую.',
    'rev.r3name': 'Sarah K.',
    'rev.r3loc': 'Великобритания',
    'rev.r3text': 'Байконур превзошёл все ожидания. Англоговорящий гид, продуманная программа, безопасность на высоте. Сам пуск - мурашки по коже.',
    'rev.r4name': 'Айгерим',
    'rev.r4loc': 'Казахстан',
    'rev.r4text': 'Возила родителей на Байконур. Всё чётко по времени, с заботой и вниманием. Спасибо команде за организацию!',
    'rev.r5name': 'Jean-Luc',
    'rev.r5loc': 'Франция',
    'rev.r5text': 'Прекрасный опыт. Дату пуска сдвинули, но TravelHub заранее предупредил и предложил удобную альтернативу. Организация отличная.',
    'rev.r6name': 'Чэнь Юй',
    'rev.r6loc': 'Китай',
    'rev.r6text': 'Гид на китайском сопровождал весь тур - очень удобно. Отель, трансферы, наблюдение с площадки - всё на высшем уровне.',
    ...
    'bk.p3': 'При отмене пуска - 100% возврат. При переносе - альтернативная дата или возврат по договору.',
    'refund.full': 'При отмене запуска гарантируется 100% возврат. В случае изменения или переноса запуска мы предложим альтернативную дату, изменение программы или возврат средств в соответствии с условиями договора.',
    ...
    'form.o1': 'Байконур: запуск, 1 день - от 170 000 ₸ / человека',
    'form.o2': 'Байконур: 3 дня - 320 000-470 000 ₸ / человека',
    'form.o3': 'Байконур: «Буран», 1 день - от 120 000 ₸ / человека',
  ...
  en: {
    ...
    't2.note': 'Crewed launch - €900 · uncrewed - from €610',
    ...
    'why.w5t': '100% refund',
    'why.w5x': 'If the launch is canceled, a 100% refund is guaranteed. In case of any change or postponement of the launch, we will offer an alternative date, a program change or a refund in accordance with the terms of the contract.',
    ...
    'nav.reviews': 'Reviews',
    'rev.title': 'Traveler reviews',
    'rev.sub': 'Real impressions from our Baikonur guests',
    'rev.avg': '4.9 out of 5 - based on traveler reviews',
    'rev.r1name': 'Li Wei',
    'rev.r1loc': 'China',
    'rev.r1text': 'I had dreamed of seeing a rocket launch since childhood. TravelHub took care of everything: permits, a Chinese-speaking guide, transfers. We watched the liftoff from the official platform - incredible emotions!',
    'rev.r2name': 'Thomas M.',
    'rev.r2loc': 'Germany',
    'rev.r2text': 'A very professional team. They arranged all the permits and documents for us - all we had to do was arrive and enjoy. Highly recommend.',
    'rev.r3name': 'Sarah K.',
    'rev.r3loc': 'United Kingdom',
    'rev.r3text': 'Baikonur exceeded all expectations. An English-speaking guide, a well-thought-out program, top-notch safety. The launch itself - goosebumps all over.',
    'rev.r4name': 'Aigerim',
    'rev.r4loc': 'Kazakhstan',
    'rev.r4text': 'I took my parents to Baikonur. Everything ran right on time, with care and attention. Thank you to the team for the organization!',
    'rev.r5name': 'Jean-Luc',
    'rev.r5loc': 'France',
    'rev.r5text': 'A wonderful experience. The launch date was moved, but TravelHub warned us in advance and offered a convenient alternative. Excellent organization.',
    'rev.r6name': 'Chen Yu',
    'rev.r6loc': 'China',
    'rev.r6text': 'A Chinese-speaking guide accompanied the whole tour - very convenient. Hotel, transfers, viewing from the platform - everything was top class.',
    ...
    'bk.p3': 'If the launch is canceled - a 100% refund. If postponed - an alternative date or a refund under the contract.',
    'refund.full': 'If the launch is canceled, a 100% refund is guaranteed. In case of any change or postponement of the launch, we will offer an alternative date, a program change or a refund in accordance with the terms of the contract.',
    ...
    'form.o1': 'Baikonur: launch, 1 day - from €320 per person',
    'form.o2': 'Baikonur: 3 days - €610-900 per person',
    'form.o3': 'Baikonur: Buran, 1 day - from €230 per person',
  ...
  zh: {
    ...
    'price.from': '起价',
    'price.request': '价格面议',
    'price.note': '价格每人 170 000 ₸ 起。最终费用取决于行程方案、发射日期及参与人数。',
    'price.unit': '/ 每人',
    ...
    'why.w5t': '100% 退款保障',
    'why.w5x': '若发射取消，保证 100% 退款。如遇发射变更或推迟，我们将根据合同条款为您提供替代日期、调整行程或退还款项。',
    'why.w6t': '专长 + 天地',
    ...
    'rev.title': '游客评价',
    'rev.sub': '拜科努尔游客的真实体验',
    'rev.avg': '4.9 / 5 - 基于游客评价',
    'rev.r1name': '李伟',
    'rev.r1loc': '中国',
    'rev.r1text': '从小就梦想亲眼看一次火箭发射。TravelHub 把一切都安排妥当：通行证、中文导游、全程接送。我们在官方观景平台观看了发射 - 那种震撼难以言表！',
    'rev.r2name': 'Thomas M.',
    'rev.r2loc': '德国',
    'rev.r2text': '团队非常专业。所有许可和文件都由他们代办 - 我们只需到场尽情享受。强烈推荐。',
    'rev.r3name': 'Sarah K.',
    'rev.r3loc': '英国',
    'rev.r3text': '拜科努尔超出了所有期待。英语导游、周到的行程、一流的安全保障。发射那一刻 - 令人起鸡皮疙瘩。',
    'rev.r4name': 'Aigerim',
    'rev.r4loc': '哈萨克斯坦',
    'rev.r4text': '我带父母去了拜科努尔。全程时间安排精准，处处贴心周到。感谢团队的组织！',
    'rev.r5name': 'Jean-Luc',
    'rev.r5loc': '法国',
    'rev.r5text': '非常棒的体验。发射日期有所调整，但 TravelHub 提前告知，并提供了合适的替代方案。组织得非常出色。',
    'rev.r6name': '陈宇',
    'rev.r6loc': '中国',
    'rev.r6text': '中文导游全程陪同 - 非常方便。酒店、接送、平台观看发射 - 一切都是顶级水准。',
    ...
    'bk.p2': '帮您选择最近发射窗口的日期',
    'bk.p3': '发射取消 - 全额退款。若推迟 - 按合同改期或退款。',
    'refund.full': '若发射取消，保证 100% 退款。如遇发射变更或推迟，我们将根据合同条款为您提供替代日期、调整行程或退还款项。',
    ...
    'form.tour': '所选线路',
    'form.tourPh': '- 请选择线路 -',
    'form.o1': '拜科努尔：发射一日游 - €320 起 / 每人',
    'form.o2': '拜科努尔：三日游 - €610-900 / 每人',
    'form.o3': '拜科努尔：“暴风雪号”一日游 - €230 起 / 每人',
...
(function reveal() {
  ...
  ['.tours-grid', '.why-grid', '.included-grid', '.contacts-grid', '.how-steps', '.reviews-grid'].forEach(function (sel) {
