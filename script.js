...
var I18N = {
  ...
  ru: {
    ...
    'hero.next': 'До ближайшего пуска - Союз / Прогресс МС-36',
    ...
    'why.w5t': 'Возврат по договору',
    'why.w5x': 'В случае изменения, переноса или отмены запуска мы предложим альтернативную дату, изменение программы или возврат средств в соответствии с условиями договора.',
    ...
    'sch.l1m': 'ноября 2026',
    'sch.l1n': 'Союз-2.1а · Прогресс МС-36',
    'sch.l1x': 'Грузовой корабль к МКС · доступны туры 1 и 3 дня, бронирование открыто',
    'sch.next': 'ближайший',
    'sch.l2m': 'ноября 2026',
  ...
  en: {
    ...
    'hero.next': 'Next launch - Soyuz / Progress MS-36',
    ...
    'why.w5t': 'Refund under the contract',
    'why.w5x': 'In case of any change, postponement or cancellation of the launch, we will offer an alternative date, a program change or a refund in accordance with the terms of the contract.',
    ...
    'sch.l1m': 'November 2026',
    'sch.l1n': 'Soyuz-2.1a · Progress MS-36',
    'sch.l1x': 'Cargo ship to the ISS · 1-day and 3-day tours available, booking open',
  ...
  zh: {
    ...
    'why.w5t': '按合同退款',
    'why.w5x': '如遇发射变更、推迟或取消，我们将根据合同条款为您提供替代日期、调整行程或退还款项。',
    'why.w6t': '专长 + 天地',
    ...
    'sch.l1m': '2026年11月',
    'sch.l1n': '联盟-2.1a · 进步MS-36',
    'sch.l1x': '国际空间站货运飞船 · 一日游与三日游均可预订，开放预订',
    'sch.next': '最近发射',
    'sch.l2m': '2026年11月',
